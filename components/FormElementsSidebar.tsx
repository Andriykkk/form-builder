...
const FormElementsSidebar = () => {
  return (
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-2 pace-y-4 place-items-center'>
        ...
        />
        <SidebarBtnElement
          formElement={FormElements.TitleField}
        />
        <SidebarBtnElement
        ...
        />
        <SidebarBtnElement
          formElement={FormElements.SpaserField}
        />
        <p className='text-sm text-muted-foreground col-span-1 md:col-span-2 my-2 place-self-start'>
          Form elements
        </p>
        ...
        />
        <SidebarBtnElement
          formElement={FormElements.NumberField}
        />
        <SidebarBtnElement
